...
#### Suppression des colonnes inutiles et renommage du data.frame    
...
Parce que la méthode nous semble plus intuitive, nous choisissons finalement de retenir les prévisions issues du modèle construit "avec les mains" (model4).
